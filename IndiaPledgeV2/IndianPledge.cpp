...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam) {
	...
	static TCHAR* pledge[][] = {
		...
		{TEXT("भारत"), TEXT("माझा"), TEXT("देश"), TEXT("आहे.")},
		{TEXT("सारे"), TEXT("भारतीय"), TEXT("माझे"), TEXT("बांधव"), TEXT("आहेत.") },
		{TEXT("माझ्या"), TEXT("देशावर"), TEXT("माझे"), TEXT("प्रेम"), TEXT("आहे.") },
		{TEXT("माझ्या"), TEXT("देशातल्या समृद्ध आणि"),
